...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="row">
            <div class="col-md-8">
                <h2>
                    <span class="label label-warning"><?= $item->price ?>vnđ</span>
                    <?php if($item->discount) : ?>
                        <del class="small"><?= $item->oldPrice ?></del>
                    <?php endif; ?>
                </h2>
                <h3>Đặc điểm</h3>
                <span class="text-muted">Thương Hiệu:</span> <?= $item->data->brand ?>
                <br/>
                ...
                <br/>
                <span class="text-muted">Trong kho:</span> <?= $item->available ? $item->available : 'Out of stock' ?>
            ...
            <div class="col-md-4">
                <?php if(Yii::$app->request->get(AddToCartForm::SUCCESS_VAR)) : ?>
                    <h4 class="text-success"><i class="glyphicon glyphicon-ok"></i> Thêm vào giỏ hàng</h4>
                <?php elseif($item->available) : ?>
                    ...
                    <div class="well well-sm">
                        ...
                        <?= Html::submitButton('Thêm vào giỏ hàng', ['class' => 'btn btn-warning']) ?>
                        <?php ActiveForm::end(); ?>
                    </div>
                <?php endif; ?>
            </div>
